...
| RAK4631  | 3.3v => 3.3v <br> GND => GND <br> SDA (Shared with OLED) => SDA <br> SCL (Shared with OLED) => SCL <br> 3.3v => SDO  | Both firmwares work <br> PowerSaving has additional features |
